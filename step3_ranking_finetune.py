...
class FinMORALReranker:
    ...
    def select_final_answer(self, question: str, candidates: List[Dict[str, Any]], 
        ...
        Output fields: text, type, mix_sc_idx, reranker_idx, final_idx (for pipeline consistency)
        """
        ...
        if len(candidates) > 1:
            ...
            reranker_best_idx = 0
        # Combine both approaches (prefer reranker for final selection)
        final_idx = reranker_best_idx
