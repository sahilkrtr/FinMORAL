...
class FinMORALEvaluator:
    ...
    def evaluate_ablation_study(self, results_file: str) -> Dict[str, Any]:
        """Ablation Study: Drop CoT, SQL, NumSolver, Reranker (Simulated, not retrained)"""
        print("Evaluating Ablation Study (Simulated, not retrained)...")
    ...
    def evaluate_modality_drop(self, results_file: str) -> Dict[str, Any]:
        """Modality Drop: Remove one modality (T, P, N, S) at a time (Simulated, not retrained)"""
        print("Evaluating Modality Drop (Simulated, not retrained)...")
